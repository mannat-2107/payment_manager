    ...
    <div class="min-h-screen bg-slate-50 font-sans pb-12">
        ...
        <div class="bg-white border-b border-slate-200 px-4 sm:px-6 lg:px-8 py-6 sticky top-16 z-40 shadow-sm">
            <div class="max-w-3xl mx-auto flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-slate-800 font-outfit tracking-tight">Create Department</h2>
                    <p class="text-sm text-slate-500 mt-1 font-medium">Add a new department to the organization</p>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('departments.store') }}">
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="description" rows="4"
                                      placeholder="Brief overview of the department's role..."
                                      class="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent text-slate-700 font-medium bg-slate-50 focus:bg-white transition-colors resize-none">{{ old('description') }}</textarea>
                        </div>
